...
var FastCGIStream = module.exports = function(stream) {
	...
	var processIncomingData = function() {
		...
		while(bufferList.length) {
			...
			if(bufferList.length >= 8 && !type) {
				...
				type = headerData[1];
				requestId = headerData.readUInt16BE(2);
				contentLength = headerData.readUInt16BE(4);
	...
	this.writeRecord = function(requestId, record, callback) {
		...
		writeBuffer.writeUInt16BE(requestId, 2);
		writeBuffer.writeUInt16BE(recordBodyLength, 4);
